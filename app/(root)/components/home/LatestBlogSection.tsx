...
import RecentBlogSection from '../../blogs/components/RecentBlogSection'
import { featuredBlogProps } from '@/types/types'

type latestBlogProps = {
  featuredBlogs: featuredBlogProps[]
}

const LatestBlogSection = ({featuredBlogs}:latestBlogProps) => {
  return (
    <Box className='pb-0 lg:pb-0 lg:pt-20 pt-16' id='latestBlogs'>
      ...
      />
      <RecentBlogSection blogList={featuredBlogs}/>
    </Box>
  )
}
