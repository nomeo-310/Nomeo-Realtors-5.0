    ...
    <Card>
      <div className='lg:p-3 p-2 md:p-0 dark:text-white'>
        ...
        <div className='lg:mb-6 mb-5'>
          <div className='p-1 border rounded-md float-left mr-2 mt-2 text-gray-500'>
            <LiaQuoteLeftSolid size={28}/>
          </div>
          <p className='text-gray-500'>{testimony}</p>
        </div>
        <div className='w-full flex gap-2 justify-between items-center'>
          <ImageAvatar src={profileImage} className='rounded-full overflow-hidden lg:w-14 lg:h-14'/>
