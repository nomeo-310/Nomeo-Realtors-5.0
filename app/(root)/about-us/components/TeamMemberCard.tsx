  ...
  return (
    <div className="w-full h-fit cursor-pointer group drop-shadow-md overflow-hidden">
      <div className="aspect-square overflow-hidden rounded-md w-full h-full relative flex items-center justify-center">
        ...
        <div className='p-8 md:p-6 absolute w-full h-full bg-black/30 z-[200] top-0 left-0 opacity-0 group-hover:opacity-100 transition translate-y-[100vh] group-hover:translate-y-0 duration-500 ease-in-out group-active:translate-y-0 flex place-items-end justify-center'>
