    ...
    <div className="pb-8 md:pb-0 h-full flex flex-col justify-between">
      ...
      <div className="flex flex-col gap-6 md:gap-8">
        <div className="flex md:gap-3 gap-2">
          <div className="lg:w-16 lg:h-16 w-12 h-12 rounded bg-neutral-700 text-white flex items-center justify-center">
            <HiOutlineHome size={36} className='hidden lg:block'/>
            <HiOutlineHome size={26} className='lg:hidden'/>
          </div>
        ...
        <div className="flex md:gap-3 gap-2">
          <div className="lg:w-16 lg:h-16 w-12 h-12 rounded bg-neutral-700 text-white flex items-center justify-center">
            <HiOutlinePhone size={36} className='hidden lg:block'/>
            <HiOutlinePhone size={26} className='lg:hidden'/>
          </div>
          <div className='flex flex-col gap-1 lg:w-[calc(100%_-_5rem)] w-[calc(100%_-_3.75rem)]'>
        ...
        <div className="flex md:gap-3 gap-2">
          <div className="lg:w-16 lg:h-16 w-12 h-12 rounded bg-neutral-700 text-white flex items-center justify-center">
            <HiOutlineEnvelope size={36} className='hidden lg:block'/>
            <HiOutlineEnvelope size={26} className='lg:hidden'/>
          </div>
          <div className='flex flex-col gap-1 lg:w-[calc(100%_-_5rem)] w-[calc(100%_-_3.75rem)]'>
            <h2 className='mb-1 md:text-xl text-lg font-semibold'>Our email address</h2>
            <p className='text-[0.95rem] leading-[1.4rem] md:text-base'>info@nomeosuites.com</p>
          </div>
        </div>
      </div>
      <div className="mt-16 flex flex-col gap-4">
        ...
        <div className='flex gap-6 items-center'>
          <a href="https://wwww.instagram.com/nomeosuites" className='hover:scale-110 bg-neutral-700 text-white w-10 h-10 lg:w-12 lg:h-12 flex rounded-full items-center justify-center'>
            <LiaInstagram size={22} className='lg:hidden'/>
            <LiaInstagram size={24} className='hidden lg:block'/>
          </a>
          <a href="https://wwww.facebook.com/nomeosuites" className='hover:scale-110 bg-neutral-700 text-white w-10 h-10 lg:w-12 lg:h-12 flex rounded-full items-center justify-center'>
            <LiaFacebookF size={22} className='lg:hidden'/>
            <LiaFacebookF size={24} className='hidden lg:block'/>
          </a>
          <a href="https://wwww.twitter.com/nomeosuites" className='hover:scale-110 bg-neutral-700 text-white w-10 h-10 lg:w-12 lg:h-12 flex rounded-full items-center justify-center'>
            <LiaTwitter size={22} className='lg:hidden'/>
            <LiaTwitter size={24} className='hidden lg:block'/>
          </a>
          <a href="https://wwww.threads.com/nomeosuites" className='hover:scale-110 bg-neutral-700 text-white w-10 h-10 lg:w-12 lg:h-12 flex rounded-full items-center justify-center'>
